...
function WayFinderDesc() {
	return (
		<div className="mt-8 font-mono text-base text-primary">
			...
			<div className="code" data-line-nr="02">
				<div className="dot">..</div>
				<div className="comment">&#47;&#47; Prototype Navigation App.</div>
			</div>
			<div className="code" data-line-nr="03">
				<div className="dot">..</div>
				<div className="comment">
			...
			<div className="code" data-line-nr="11">
				...
				<span className="string">
					{' '}
					&#39;Google maps does not work for footpaths so it is difficult for
					new students and faculty to navigate the campus.&#39;
				</span>
				,
			</div>
			<div className="code" data-line-nr="12">
				...
				<span className="string">
					{' '}
					&#39;Given four weeks to develop a functional prototype app.&#39;
				</span>
				,
			</div>
			<div className="code" data-line-nr="13">
				...
				<span className="string">
					{' '}
					&#39;Create a MVP navigation app for the BCIT Burnaby Campus.&#39;
				</span>
				,
			</div>
			<div className="code" data-line-nr="14">
			...
			<div className="code" data-line-nr="23">
				...
				<span className="string"> &#39;Color coordinated map markers&#39;</span>
				,
				<span className="string">
					{' '}
				...
				,
				<span className="string"> &#39;Familiar UX/UI to google maps&#39;</span>
			</div>
			<div className="code" data-line-nr="24">
				<div className="dot">....</div>
				&#93;
