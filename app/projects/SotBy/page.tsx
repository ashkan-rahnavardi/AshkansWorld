				...
				<div className="bd-sidebar col-sm-12 col-md-4">
					<div>
						...
						<div className="projectDescription mb-8">
							...
							BCIT&#39;s Automotive Department. I was apart of a team of 3
							students and we were given 4 weeks to complete this project. Given
							the short time frame, I am proud of all that we were able to
							accomplish.
						</div>
