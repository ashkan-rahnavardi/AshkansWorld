				...
				<div className="bd-sidebar col-sm-12 col-md-4">
					<div>
						...
						<div className="projectDescription mb-8">
							...
							inspired by Google Maps. The app played a pivotal role in securing
							funding for commercial development. Created and implemented from
							scratch within a 4-week timeframe, with collaborative efforts from
							a team of three students.
						</div>

						<div className="projectDescription mb-8">
							<span className="projectDescription__highlight">Features: </span>
							Autocomplete search bar for buildings and amenities, Geolocation,
							Color coordinated map markers, Building/Amenity photo and
							description.
						</div>
					</div>
					...
					<div>
						...
						<div className="divider-line text-primary mt-4">02</div>
					</div>
				</div>
			</div>
		</div>
